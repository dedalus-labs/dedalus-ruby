...
class Dedalus::Test::PrimitiveModelTest < Minitest::Test
  A = Dedalus::Internal::Type::ArrayOf[-> { Integer }]
  H = Dedalus::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  class B < Dedalus::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    converters = [
      Dedalus::Internal::Type::Unknown,
      Dedalus::Internal::Type::Boolean,
      A,
      H,
      E,
      U,
    ...
    converters.each do |conv|
      assert_pattern do
        conv => Dedalus::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [Dedalus::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [Dedalus::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [Dedalus::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = Dedalus::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        Dedalus::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [Dedalus::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [Dedalus::Internal::Type::Boolean, true] => true,
      [Dedalus::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => Dedalus::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        Dedalus::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = Dedalus::Internal::Type::Converter.new_coerce_state
      Dedalus::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        Dedalus::Internal::Type::Converter.dump(target, input, state: state)
...
class Dedalus::Test::EnumModelTest < Minitest::Test
  class E0
    include Dedalus::Internal::Type::Enum
...
class Dedalus::Test::CollectionModelTest < Minitest::Test
  A1 = Dedalus::Internal::Type::ArrayOf[-> { Integer }]
  H1 = Dedalus::Internal::Type::HashOf[Integer]

  A2 = Dedalus::Internal::Type::ArrayOf[H1]
  H2 = Dedalus::Internal::Type::HashOf[-> { A1 }]

  A3 = Dedalus::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = Dedalus::Internal::Type::HashOf[Integer, nil?: true]
...
class Dedalus::Test::BaseModelTest < Minitest::Test
  class M1 < Dedalus::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < Dedalus::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < Dedalus::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, Dedalus::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = Dedalus::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = Dedalus::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(Dedalus::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue Dedalus::Errors::ConversionError => e
...
class Dedalus::Test::UnionTest < Minitest::Test
  class U0
    include Dedalus::Internal::Type::Union
  ...
  class M2 < Dedalus::Internal::Type::BaseModel
  ...
  class M4 < Dedalus::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, Dedalus::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < Dedalus::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, Dedalus::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class Dedalus::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include Dedalus::Internal::Type::Enum
  ...
  def test_equality
    cases = {
      [Dedalus::Internal::Type::Unknown, Dedalus::Internal::Type::Unknown] => true,
      [Dedalus::Internal::Type::Boolean, Dedalus::Internal::Type::Boolean] => true,
      [Dedalus::Internal::Type::Unknown, Dedalus::Internal::Type::Boolean] => false,
...
class Dedalus::Test::MetaInfoTest < Minitest::Test
  A1 = Dedalus::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = Dedalus::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
