...
class DedalusTest < Minitest::Test
  ...
  def test_client_default_request_default_retry_attempts
    stub_request(:post, "http://localhost/v1/machines").to_return_json(status: 500, body: {})
  ...
  def test_client_retry_after_seconds
    stub_request(:post, "http://localhost/v1/machines").to_return_json(
      status: 500,
  ...
  def test_client_redirect_307
    ...
    assert_requested(:any, "http://localhost/redirected", times: Dedalus::Client::MAX_REDIRECTS) do
  ...
  def test_default_headers
    stub_request(:post, "http://localhost/v1/machines").to_return_json(status: 200, body: {})
