...
module Dedalus
  module Models
    module Machines
      class ExecutionRetrieveParams < Dedalus::Internal::Type::BaseModel
        ...
        OrHash =
          T.type_alias do
            T.any(
              Dedalus::Machines::ExecutionRetrieveParams,
        ...
        def self.new(machine_id:, execution_id:, request_options: {})
        end
