  ...
  module Internal
    ...
    module Util
      ...
      class << self
        ...
        sig do
          params(url: T.any(URI::Generic, String)).returns(
            Dedalus::Internal::Util::ParsedUri
          )
        end
        def parse_uri(url)
        end
        ...
        # @api private
        sig do
          params(parsed: Dedalus::Internal::Util::ParsedUri).returns(
            URI::Generic
          )
        end
        ...
        sig do
          params(
            lhs: Dedalus::Internal::Util::ParsedUri,
            rhs: Dedalus::Internal::Util::ParsedUri
          ).returns(URI::Generic)
        end
      ...
      class << self
        # @api private
        sig do
          params(query: Dedalus::Internal::AnyHash).returns(
            Dedalus::Internal::AnyHash
          )
        end
        ...
        sig do
          params(
            collection: Dedalus::Internal::AnyHash,
            key: String,
            element: T.anything
          ).void
        end
      ...
      class << self
        ...
        sig do
          params(lines: T::Enumerable[String]).returns(
            T::Enumerable[Dedalus::Internal::Util::ServerSentEvent]
          )
        end
      ...
      module SorbetRuntimeSupport
        ...
        class << self
          ...
          sig do
            params(
              type:
                T.any(Dedalus::Internal::Util::SorbetRuntimeSupport, T.anything)
            ).returns(T.anything)
          end
