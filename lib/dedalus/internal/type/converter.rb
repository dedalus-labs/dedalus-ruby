    ...
    module Type
      ...
      module Converter
        ...
        def dump(value, state:)
          case value
          in Array
            value.map { Dedalus::Internal::Type::Unknown.dump(_1, state: state) }
          in Hash
            value.transform_values { Dedalus::Internal::Type::Unknown.dump(_1, state: state) }
        ...
        class << self
          ...
          def type_info(spec)
            ...
            in Dedalus::Internal::Type::Converter | Class | Symbol
              -> { spec }
          ...
          #
          # @param target [Dedalus::Internal::Type::Converter, Class]
          #
          # @param value [Object]
          #
          ...
          #
          # @return [Object]
          def coerce(target, value, state: Dedalus::Internal::Type::Converter.new_coerce_state)
            # rubocop:disable Metrics/BlockNesting
            exactness = state.fetch(:exactness)

            case target
            in Dedalus::Internal::Type::Converter
          ...
          def dump(target, value, state: {can_retry: true})
            ...
            in Dedalus::Internal::Type::Converter
              ...
              Dedalus::Internal::Type::Unknown.dump(value, state: state)
            end
          end
        ...
        define_sorbet_constant!(:Input) do
          T.type_alias { T.any(Dedalus::Internal::Type::Converter, T::Class[T.anything]) }
        end
