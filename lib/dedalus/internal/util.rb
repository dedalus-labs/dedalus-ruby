    ...
    module Util
      ...
      class << self
        ...
        def coerce_hash!(input)
          ...
          in Hash | nil => coerced
            ...
            message = "Expected a #{Hash} or #{Dedalus::Internal::Type::BaseModel}, got #{input.inspect}"
      ...
      class << self
        ...
        def encode_path(path)
          path.to_s.gsub(Dedalus::Internal::Util::RFC_3986_NOT_PCHARS) { ERB::Util.url_encode(_1) }
        end
      ...
      class << self
        ...
        private def write_multipart_chunk(y, boundary:, key:, val:, closing:)
          ...
          case val
          in Dedalus::FilePart unless val.filename.nil?
          ...
          strio = writable_enum do |y|
            ...
            in Hash
              body.each do |key, val|
                case val
                in Array if val.all? { primitive?(_1) || Dedalus::Internal::Type::FileInput === _1 }
                  val.each do |v|
        ...
        def encode_content(headers, body)
          ...
          in [Dedalus::Internal::Util::JSON_CONTENT, Hash | Array | -> { primitive?(_1) }]
            [headers, JSON.generate(body)]
          in [Dedalus::Internal::Util::JSONL_CONTENT, Enumerable] unless Dedalus::Internal::Type::FileInput === body
            [headers, body.lazy.map { JSON.generate(_1) }]
          in [%r{^multipart/form-data}, Hash | Dedalus::Internal::Type::FileInput]
        ...
        def decode_content(headers, stream:, suppress_error: false)
          ...
          in Dedalus::Internal::Util::JSON_CONTENT
          ...
          in Dedalus::Internal::Util::JSONL_CONTENT
      ...
      module SorbetRuntimeSupport
        ...
        class << self
          # @api private
          #
          # @param type [Dedalus::Internal::Util::SorbetRuntimeSupport, Object]
          #
          # @return [Object]
          def to_sorbet_type(type)
            case type
            in Dedalus::Internal::Util::SorbetRuntimeSupport
              type.to_sorbet_type
            in Class | Module
              type
            in true | false
